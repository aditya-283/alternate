...
train_accs = []
test_accs = []
with open("cifar_100.txt") as acc:
...
plt.plot([warmup - 1] * 100, range(100), "--", linewidth=1, label=f"Warmup {warmup} epochs")
...
plt.title("ResNet18 model with UV training on CIFAR-100")
plt.show()